...
public class ClassDataService : IClassDataService
{
    ...
    private readonly List<CharacterClass> _classes = new()
    {
        ...
        new CharacterClass
        {
            ...
            {
                new ClassTrait { PD = 1, TraitName = "Small", Effect = "Mouse, rat, or bird-sized. AGI 13, VIG 2." },
                new ClassTrait { PD = 1, TraitName = "Keen Smell", Effect = "Heightened senses relating to smell; find food, follow trails etc." },
                new ClassTrait { PD = 1, TraitName = "Keen Sight", Effect = "Heightened senses relating to sight; spot long-distance targets etc." },
                new ClassTrait { PD = 1, TraitName = "Keen Hearing", Effect = "Heightened senses relating to hearing; listen for ambushes etc." },
                new ClassTrait { PD = 1, TraitName = "Burrow", Effect = "Move freely through the ground. Must be Small." },
                new ClassTrait { PD = 1, TraitName = "Flight 1", Effect = "Move freely through the air. Must be Small. AGI 16" },
                new ClassTrait { PD = 1, TraitName = "Attack 1", Effect = "Use your body, beak, teeth, etc. 1d4 damage." },
                new ClassTrait { PD = 2, TraitName = "Natural Climber", Effect = "Climb like a monkey or squirrel. AGI 12." },
                new ClassTrait { PD = 2, TraitName = "Beast of Burden", Effect = "Carry up to 10 Inventory slots. Requires bags or pouches. VIG 15." },
                new ClassTrait { PD = 2, TraitName = "Natural Sprinter", Effect = "You can outrun most creatures. AGI 16." },
                new ClassTrait { PD = 2, TraitName = "Night Vision", Effect = "You can see well in low-light conditions." },
                new ClassTrait { PD = 2, TraitName = "Camouflage", Effect = "Very hard to detect, due to natural or shifting colors." },
                new ClassTrait { PD = 2, TraitName = "Amphibious", Effect = "Can breathe underwater through gills etc. Must be Small." },
                new ClassTrait { PD = 2, TraitName = "Attack 2", Effect = "Use your claws, fangs, etc. 1d6 damage." },
                new ClassTrait { PD = 2, TraitName = "Duration 1", Effect = "Stay transformed for 1 hour." },
                new ClassTrait { PD = 3, TraitName = "Large", Effect = "Cow, bear, alligator, shark, or similar. VIG 16." },
                new ClassTrait { PD = 3, TraitName = "Strong", Effect = "Gorilla, bull, or similar. VIG 18." },
                new ClassTrait { PD = 3, TraitName = "Flight 2", Effect = "Move freely through the air. Doesn't work for Large forms. AGI 15." },
                new ClassTrait { PD = 3, TraitName = "Thick Hide 1", Effect = "Gain 1 Armor." },
                new ClassTrait { PD = 3, TraitName = "Duration 2", Effect = "Stay transformed for 4 hours." },
                new ClassTrait { PD = 3, TraitName = "Attack 3", Effect = "Use your talons, razor-sharp teeth, etc. 1d8 damage." },
                new ClassTrait { PD = 3, TraitName = "Elemental 1", Effect = "Gain a venomous, acidic, or similar Close attack. 1d6 damage + effect." },
                new ClassTrait { PD = 4, TraitName = "Flight 3", Effect = "Move freely through the air, works for Large forms. AGI 15." },
                new ClassTrait { PD = 4, TraitName = "Thick Hide 2", Effect = "Gain 2 Armor." },
                new ClassTrait { PD = 4, TraitName = "Attack 4", Effect = "Use your horns, mighty bite, vicious claws. 1d10 damage." },
                new ClassTrait { PD = 4, TraitName = "Duration 3", Effect = "Stay transformed for 1 day." },
                new ClassTrait { PD = 4, TraitName = "Elemental 2", Effect = "Breathe fire, acid, etc. to targets Nearby. 1d8 damage, blast." },
            },
        }
    };
